...
function Login(props) {
  ...
  return (
    <div className="App">
        ...
        <h3>Login</h3>
        <div>Before you can access the application, you have to login with your personal spotify account</div>
        <div style={{marginTop : '20px'}}><Button style={{fontSize : '20px', padding : '20px 30px', borderRadius : '40px'}} variant='light' onClick={handleLogin}>Login with Spotify</Button></div>
    </div>
  );
}
